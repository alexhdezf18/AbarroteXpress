    ...
    <div class="min-h-screen bg-gradient-to-br from-marca-oscuro via-indigo-800 to-marca-oscuro flex items-center justify-center p-4">
      <div class="w-full max-w-md">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-8">
          ...
          <form (ngSubmit)="ingresar()" class="space-y-4">
            <div>
          ...
          <p class="text-center text-sm text-slate-500 mt-6">
            ¿Eres una tienda nueva?
            <a routerLink="/registro" class="text-indigo-600 font-semibold hover:text-indigo-700">Registra tu tienda</a>
          </p>
        </div>
      </div>
    </div>
